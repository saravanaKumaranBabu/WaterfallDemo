...
const GrossProceedsAccordion = (props) => {

    const [GRInputs, setGRInputs] = useState({
        input1: false,
        input2: false,
        input3: false,
        input4: false
        ...
        <>
            <div style={{ display: 'flex', gap: '8px', marginTop: '15px' }}>
                ...
                <Card className="footer-card" style={{ borderRadius: '8px', width: '100%', margin: '0px', padding: '10px' }}>
                    <div className="gross-proceeds-details"
                        style={{ display: 'flex', flexDirection: 'column', padding: '0px', margin: '0px', height: 'auto', width: '100%' }}>

                        <p className="gross-proceeds-text" style={{ marginBottom: '12px', fontSize: '16px' }}>Gross Proceeds</p>
                        <table>
                            <tr>
                                <td style={{ display: 'flex', justifyContent: 'space-between', padding: '0px 2px 14px' }}
                                    className="left-accordion-col"
                                    onClick={() => {
                                        setGRInputs(GRInputs => ({
                                            input1: !GRInputs.input1,
            ...
            {
                GRInputs.input1 && <div style={{ display: 'flex', gap: '8px', marginTop: '15px' }}>
            ...
            {
                GRInputs.input2 && <div style={{ display: 'flex', gap: '8px', marginTop: '15px' }}>
                    <div className="vl-reverse-sub" style={{ left: '30px', bottom: '127px', height: '92px' }}></div>
                    <button className="plus" style={{
                        position: 'static',
                        boxShadow: '0px 8.14815px 6.51852px rgb(41 72 152 / 9%), 0px -3.14815px 3.14815px rgb(41 72 152 / 5%)'
...
export default GrossProceedsAccordion;