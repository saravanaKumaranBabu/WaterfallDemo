...
const PeriodCloseActions = (props) => {
    ...
    const columns = [
        {
            ...
            Header: 'Unrecouped Allocated Fees and Expenses',
            accessor: 'urafe'
        }, {
        ...
        {
            Header: 'Adjusted Cumulative Net Gain',
            accessor: 'url'
        }
                        ...
                        <TableBody>

                          {
                            ...
                            /></TableCell>
                                ...
                                ><NumberFormat
                                value={row.allocatedFeesAndExpenses}
                                displayType={"text"}
                                thousandSeparator={true}
                                prefix={"$"}
                            /></TableCell>
                            ...
                            /></TableCell>
                                ...
                                ><NumberFormat
                                value={row.unrealizedAllocatedFeesAndExpenses}
                                displayType={"text"}
                                thousandSeparator={true}
                                prefix={"$"}
                            /></TableCell>
                            ...
                            {/* <TableRow style={{ background: '#FFF6DC', height: '50px' }}>
                                <TableCell
                                    className="tableRow-hover"
                                    onClick={() => {
                                        setCurrentRow({})
                                ...
                                >Alludo (fka Corel Corporation)</TableCell>
                                <TableCell
                                    className="tableRow-hover"
                                    style={{
                                        fontFamily: 'Roboto',
                            ...
                            </TableRow>
                            {
                                iterator.map((item, index) => (
                                    <TableRow key={'pcaRow-' + index} style={{ height: '50px' }}>
                                        <TableCell
                                            onClick={() => {
                                                setCurrentRow({})
                                                setClicked(true)
...
export default PeriodCloseActions;